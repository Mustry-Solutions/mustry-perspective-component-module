...
| `/grid` | GridDemo | Data Grid M0+M1: 2,500 evergreen work orders — virtualization, frozen columns, sort, quick filter, multi-select, column reorder/resize/hide, typed formatting, conditional styling, CSV export. |
