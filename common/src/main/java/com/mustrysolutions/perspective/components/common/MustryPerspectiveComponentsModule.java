 ...
 */
public class MustryPerspectiveComponentsModule {

    /** Module id — must match {@code id} in the root build.gradle.kts. */
    public static final String MODULE_ID =
        "com.mustrysolutions.perspective.components";
    ...
    public static JsonSchema schema(String resourcePath) {
        return JsonSchema.parse(
            MustryPerspectiveComponentsModule.class.getResourceAsStream(resourcePath));
    }
    ...
    public static BufferedImage paletteIcon(String id) {
        ...
        if (k.contains("codeeditor")) {
            ...
            g.drawLine(5, 14, 11, 14);                            // code line
        } else if (k.contains("richtexteditor")) {
            ...
            g.drawLine(2, 6, 14, 6);                              // header rule
            g.drawLine(5, 1, 5, 4); g.drawLine(11, 1, 11, 4);     // binder rings
            g.fillOval(8, 8, 4, 4);                               // the holiday
