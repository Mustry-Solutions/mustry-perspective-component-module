...
export interface TimelineLabels {
    ...
    zoomSecond: string; zoomMinute: string; zoomHour: string; zoomDay: string; zoomShift: string; zoomWeek: string;   // zoom-preset buttons
...
export const EN_TIMELINE_LABELS: TimelineLabels = {
    ...
    zoomSecond: 'Second', zoomMinute: 'Minute', zoomHour: 'Hour', zoomDay: 'Day', zoomShift: 'Shift', zoomWeek: 'Week',
...
const TIMELINE_PACKS: { [lang: string]: TimelineLabels } = {
    fr: {
        ...
        zoomSecond: 'Seconde', zoomMinute: 'Minute', zoomHour: 'Heure', zoomDay: 'Jour', zoomShift: 'Poste', zoomWeek: 'Semaine',
    ...
    de: {
        ...
        zoomSecond: 'Sekunde', zoomMinute: 'Minute', zoomHour: 'Stunde', zoomDay: 'Tag', zoomShift: 'Schicht', zoomWeek: 'Woche',
    ...
    es: {
        ...
        zoomSecond: 'Segundo', zoomMinute: 'Minuto', zoomHour: 'Hora', zoomDay: 'Día', zoomShift: 'Turno', zoomWeek: 'Semana',
    ...
    nl: {
        ...
        zoomSecond: 'Seconde', zoomMinute: 'Minuut', zoomHour: 'Uur', zoomDay: 'Dag', zoomShift: 'Ploeg', zoomWeek: 'Week',
    ...
    it: {
        ...
        zoomSecond: 'Secondo', zoomMinute: 'Minuto', zoomHour: 'Ora', zoomDay: 'Giorno', zoomShift: 'Turno', zoomWeek: 'Settimana',
    ...
    pt: {
        ...
        zoomSecond: 'Segundo', zoomMinute: 'Minuto', zoomHour: 'Hora', zoomDay: 'Dia', zoomShift: 'Turno', zoomWeek: 'Semana',
