...
// event placement and time-grid packing, unit-tested without rendering.
// Recurrence expansion lives in the shared layer (shared/recurrence.ts).

import {
    addDays, fmtDate, firstCellOffset, pad2, parseDate, sameDay,
