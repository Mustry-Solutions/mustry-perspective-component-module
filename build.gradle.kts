...
ignitionModule {
     ...
     */
    hooks.putAll(mapOf(
        "com.mustrysolutions.perspective.components.gateway.MustryPerspectiveComponentsGatewayHook" to "G",
        "com.mustrysolutions.perspective.components.designer.MustryPerspectiveComponentsDesignerHook" to "D"
    ))
